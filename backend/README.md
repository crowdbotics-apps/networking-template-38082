...
## Project Structure
    ...
    ├── networking_template_38082  # Django project configurations
...
1. Clone this repo and `cd networking_template_38082`
...
2. Clone this repo and `cd networking_template_38082`
