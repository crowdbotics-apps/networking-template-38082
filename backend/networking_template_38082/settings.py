"""
Django settings for networking_template_38082 project.
...
ROOT_URLCONF = 'networking_template_38082.urls'
...
WSGI_APPLICATION = 'networking_template_38082.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "networking_template_38082 API",
    "DESCRIPTION": "API documentation for networking_template_38082 App",
    "VERSION": "v1",
}
